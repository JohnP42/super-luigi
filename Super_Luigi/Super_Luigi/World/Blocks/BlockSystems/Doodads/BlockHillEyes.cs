...
{
    class BlockHillEyes : Block
    {
        public BlockHillEyes(int x, int y, int index)
        {
            ...
            {
                if (i < 2)
                    this.SrcRect[i] = new Rectangle(i * 17, 323, 16, 16);
                else
                    this.SrcRect[i] = new Rectangle((i - 2) * 17, 340, 16, 16);
            }
        }
    }
}